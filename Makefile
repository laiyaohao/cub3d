...
UTILS_FILENAMES := strcjoin.c cleanup.c pixel_put.c draw_to_img.c
...
B_GRAPHICS_FILENAMES := b_game.c b_controls.c b_player.c b_images.c b_floor_render.c b_wall_render.c b_wall_texture.c b_minimap.c b_mouse.c b_door.c
