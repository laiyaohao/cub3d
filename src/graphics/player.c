...
void    move_player(double *new_x, double *new_y, t_game *game, double move_speed)
{
    *new_x = game->p.p_x;
    *new_y = game->p.p_y;
...
void    rotate_player(t_game *game, double rot_speed)
{
    ...
    game->p.plane_x = game->p.plane_x * cos(rot_speed) - game->p.plane_y * sin(rot_speed);
    game->p.plane_y = old_planex * sin(rot_speed) + game->p.plane_y * cos(rot_speed);
}
